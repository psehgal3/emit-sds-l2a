...
def train_test(x_array, y_array, loc_list, model):
    ...
    print(score)
    return x_test, predictions, loc_test, y_test 
...
def create_classification_map(x_test, predictions, annotation_array, loc_test):
...
def save_test_values(x_test, y_test, x_test_files, y_test_files):
...
if __name__ == "__main__":
    ...
    for infile in files:
        ...
        x_test, predictions, loc_test, y_test = train_test(reflectance, label, loc_list, model)
        save_test_values(x_test, y_test, predictions, x_test_files, y_test_files)
    for infile in files:
        create_classification_map(x_test, predictions, annotation_array, loc_test)