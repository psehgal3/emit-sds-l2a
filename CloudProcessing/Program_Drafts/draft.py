...
def calculate_TOA_reflectance(elevation_angle, radiances):
    zenith_rad = (90 - float(elevation_angle))*pi/180
    reflectance_array = []
...
if __name__ == "__main__":
    ...
    for infile in files:
        ...
        reflectance = calculate_TOA_reflectance(elevation, radiance)
